...
repository:
      ...
      binary-operators:
        match: |-
          ...
          (?:
            ...
            | ( ![.:>] ) # mandatory
            | ( (?:\.|::|->) ) # accessors
            | ( &&|\|\||\^\^|Â§Â§|Â¦Â¦|Â¤Â¤|Â«Â«|Â»Â»|â€¹â€¹|â€ºâ€º|~~|Â¬Â¬|â€ â€ |â€¡â€¡|Â°Â° ) # logical
            | ( [&|^Â§Â¦Â¤Â«Â»â€¹â€º~Â¬â€ â€¡Â°] ) # bitwise
            | ( <<[<>]?|[<>]?>> ) # bitwise shift
            | ( \+\+|--|Ã—Ã—|Ã·Ã·|Â±Â±|%% ) # string
            | ( [+\-Ã—Ã·Â±][%|]?|\*\*?[%|]?|~?/|%%? ) # arithmetic
            | ( [|+*$]>|<[|+*$] ) # pipeline
            ...
            | ( [!-Ã¿&&[\p{S}\p{P}&&[^.,:;'"`|<>/\\()\[\]{}\p{Pc}]]]+ # ascii operators
                (?:[!-Ã¿&&[\p{S}\p{P}]]*
                  [!-Ã¿&&[\p{S}\p{P}&&[^.,:;'"`|<>/\\()\[\]{}\p{Pc}]]]+
                )?
              )
  ...
  directives:
    ...
    patterns:
      - applyEndPatternLast: true
        begin: ^\s*(%)(if|elif|else|end|ifn?def|elifn?def|endif)\b
        end: $
      ...
      - applyEndPatternLast: true
        comment: '%define <ident> [(params)] expr'
        begin: ^\s*(%)(define)\b\s+
        end: $
        name: meta.directive.ruko
        beginCaptures:
        ...
        patterns:
          - begin: |-
              (?x)
              (?<=^\s*%define\b\s+) # match %define <ident> [(params)] expr
              (?!
                (?<!['"`)\]}\w\s](?:[?!]?\.|[?!:]:|[?!-]>)=?)
            ...
            beginCaptures:
              1: {name: entity.name.constant.macro.ruko}
            patterns:
              - begin: (\#?\()\s*
                end: \s*(\))
                captures:
      ...
      - applyEndPatternLast: true
        ...
        patterns:
          - match: |-
              ...
              ((?>`(?>``|[^`])+`|\b[\p{L}\p{Nl}\p{Pc}]\w*\b))
            captures:
              1: {name: entity.name.pragma.ruko}
          - include: $self
      - applyEndPatternLast: true
        begin: ^\s*(%)(region|endregion|once)\b
        end: $
        name: meta.directive.ruko
        captures:
          1: {name: punctuation.definition.directive.ruko}
        ...
        patterns: [{include: $self}]
      - applyEndPatternLast: true
        begin: ^\s*(%)(info|error|warn|trace|debug|fatal)\b
        end: $
        name: meta.directive.ruko
        captures:
          1: {name: punctuation.definition.directive.ruko}
    ...
    patterns:
      ...
      - match: |-
          ...
          (
            ...
            (?:
              (?:
                #this.repository.define.repository['prefix-type-annotation-no-infix'].match.split('<0>').join('<1>')
              )
              \s*
            )+
          )
  ...
  style-entries:
    ...
    begin: |-
      ...
      (
        (?:
          \s*
          #this.repository.define.repository['prefix-type-annotation'].match.split('<0>').join('<1>')
        )+
      )
      \s*
      (:)(?=\s+|$)
    ...
    patterns:
      - comment: Backward piped function calls
        ...
        match: |-
          ...
          (?=
              \s+ (?:<[|+*$]>?|[.Â·$]) (\s+|$) # infix operator
            | (?:<[|+*$]>?|[Â·Â°]) # interfix operator
          )
        captures:
          1:
  ...
  modifier-keywords:
    ...
    match: |-
      ...
      (?=
        \s*(?<!['"`)\]}\w\s](?:[?!]?\.|[?!:]:|[?!-]>)=?)
        #this.repository.define.repository['declaration-keywords'].match
        \s*
      )
    captures:
      1:
    ...
    patterns:
      ...
      - begin: |-
          ...
          ((?# group 3)
            ...
            (?:
              (?:
                #this.repository.define.repository['prefix-type-annotation'].match.split('<0>').join('<3>')
              )
              \s*
            )+
          )?
      ...
      - comment: Lambda starting and ending with |
        ...
        begin: |-
          ...
          (\|) (?=(
            ...
            (?:
              (?:
                #this.repository.define.repository['prefix-type-annotation'].match.split('<0>').join('<4>')
              )
              \s*
            )+
          ) | \#?[(\[{] # opening bracket
    ...
    patterns:
      ...
      - begin: |-
        ...
        patterns:
          ...
          - include: '#angle-brackets'
          - include: '#accessor-operators'
          - include: '#selector-type-cast-operators'
          - include: '#brackets'
          - include: '#operators'
          - include: '#variables'
          - include: '#illegal'
  ...
  stdlib-unicode-keys:
    ...
    patterns:
      ...
      - comment: Miscellaneous Unicode property aliases and canonical names (incl. Unicode 18.0 Unihan/Seal/Jurchen sources)
        match: |-
          (?xi)\b(
              kJURC_Src                | kJURC_Src
        ...
        name: support.type.property-name.unicode.miscellaneous.ruko
  ...
  stdlib-unicode-values:
    ...
    patterns:
      - comment: Unicode Block property values
        match: |-
          (?xi)\b(
              Adlam                               | Adlam
            ...
            | Batak                               | Batak
            | Bengali                             | Bengali
            | Bengali_Sup                         | Bengali_Supplement
            ...
            | Misc_Arrows_Ext                     | Miscellaneous_Symbols_And_Arrows_Extended
            ...
            | Music_Sup                           | Musical_Symbols_Supplement
            | Myanmar                             | Myanmar
      ...
      - comment: Unicode Script property values (ISO 15924 4-character tags)
        match: |-
          (?xi)\b(
              Adlm | Adlam
        ...
        name: support.constant.property-value.unicode.script.ruko
  ...
  type-names:
    ...
    patterns:
      ...
      - comment: |-
          ...
          oct: octonion (a + bi + cj + dk + eâ„“ + fm + gn + ho)
        match: |-
          (?x)\b(
